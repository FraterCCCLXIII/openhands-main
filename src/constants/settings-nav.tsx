import { AppWindow, Brain, Shield, Smartphone } from "lucide-react";
...
export const OSS_NAV_ITEMS: SettingsNavItem[] = [
  ...
  {
    icon: <Smartphone className="size-4" strokeWidth={2} aria-hidden />,
    to: "/settings/mobile",
    text: "SETTINGS$NAV_MOBILE",
    subtitle: "SETTINGS$PAGE_MOBILE_SUBLINE",
  },
];
